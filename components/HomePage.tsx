...
const PublicGeographyMap = dynamic(() => import("@/components/PublicGeographyMap"), {
  ssr: false,
});

/** Ward Signup (LDS) — landing examples */
...
export default function Home() {
  ...
  const homeUseCases = WARD_HOME_USE_CASES;
    ...
    <div className="min-h-screen">
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center px-6 pt-[104px] pb-[72px] overflow-hidden bg-gradient-to-br from-[#22C8D8] via-[#0E96B0] to-[#08647E]">
        ...
        <div className="relative z-[2] flex flex-col items-center text-center max-w-[660px] w-full">
          ...
          <Link 
              href="/use-cases/tithing-declaration" 
              className="inline-flex items-center gap-2 text-[13px] font-medium px-4 py-2 rounded-full bg-white/15 border border-white/30 text-white no-underline backdrop-blur-[8px] transition-all duration-200 hover:bg-white/25 mb-8 animate-fadeUp" 
          ...
          <div className="relative z-[2] mt-10 flex flex-wrap gap-3 justify-center animate-fadeUp" style={{ animationDelay: "0.35s" }}>
              <Link
                href="/use-cases/ward-secretary-signup"
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-white/18 border border-white/32 text-white text-sm font-medium no-underline backdrop-blur-[8px] transition-all duration-200 hover:bg-white/25 hover:border-white/40"
              >
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/>
                  <polyline points="14 2 14 8 20 8"/>
                </svg>
                Ward Secretary Guide
              </Link>
              <Link
                href="/use-cases/tithing-declaration"
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-white/18 border border-white/32 text-white text-sm font-medium no-underline backdrop-blur-[8px] transition-all duration-200 hover:bg-white/25 hover:border-white/40"
      ...
      <section className="py-[88px] px-6 max-w-[1080px] mx-auto">
        ...
        <h2 className="font-serif text-[clamp(28px,4vw,44px)] text-center tracking-[-0.6px] text-[#0D2B35] mb-3.5 leading-[1.15]">
          Everything your secretary needs
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          ...
          <div className="bg-white rounded-2xl p-[32px_26px] border border-[#0E96B0]/9 shadow-[0_2px_8px_rgba(8,100,126,0.10)] transition-all duration-[250ms] relative overflow-hidden hover:-translate-y-1 hover:shadow-[0_8px_32px_rgba(8,100,126,0.14)] group">
            ...
            <p className="text-sm text-[#5A8399] leading-[1.65]">
              People just pick a slot and enter their name — zero friction, zero barriers. As simple as a paper sheet, but online.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-[88px] px-6">
        <div className="max-w-[1080px] mx-auto">
          ...
          <h2 className="font-serif text-[clamp(28px,4vw,44px)] text-center tracking-[-0.6px] text-[#0D2B35] mb-3.5 leading-[1.15]">
            Wards using our platform
          </h2>
          <p className="text-[17px] text-[#5A8399] text-center max-w-[500px] mx-auto mb-14 leading-[1.65]">
            Join users from cities around the world who are simplifying their scheduling.
          </p>
          <PublicGeographyMap />
        </div>
      </section>
      ...
      {/* Trust Line */}
      <section className="py-6 px-6 max-w-[680px] mx-auto text-center">
        <p className="text-[15px] text-[#5A8399] leading-[1.7]">
          Built for ward signup sheets: no member accounts, and <strong>ad free</strong> signup pages.{" "}
          <Link href="/ad-free" className="text-[#0E96B0] hover:text-[#08647E] font-medium transition-colors">
            Read how
          </Link>
        </p>
      </section>
        ...
        <div className="max-w-[760px] w-full bg-gradient-to-br from-[#22C8D8] via-[#0E96B0] to-[#08647E] rounded-[28px] p-[64px_72px] shadow-[0_20px_60px_rgba(8,100,126,0.22)] text-center relative overflow-hidden">
          ...
          <div className="relative z-[1]">
            ...
            <p className="text-[17px] text-white/75 mb-9 max-w-[480px] mx-auto leading-[1.6]">
              Free to use — no credit card, no setup fee, no complexity.
              {showSupport && (
                <>
                  {" "}
                  Optional{" "}
                  <Link
                    ...
                    className="text-white font-medium underline underline-offset-2 decoration-white/50 hover:decoration-white"
                  >
                    Support the Project
                  </Link>{" "}
                  helps cover hosting.
